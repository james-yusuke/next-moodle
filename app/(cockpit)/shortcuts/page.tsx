...
export default function ShortcutsPage() {
  return (
    <div className="ui-page-stack">
      <header className="ui-page-header"><div><h1>キーボードショートカット</h1></div><p>マウスへ移動せず、学習画面を操作できます。</p></header>
      <section className="ui-shortcuts" aria-labelledby="shortcut-list-title">
