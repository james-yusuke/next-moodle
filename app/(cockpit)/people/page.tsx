...
export default async function PeoplePage() {
  ...
  if (courses.kind === "failure") return <StateNotice reason={courses.reason} retryHref="/people" siteUrl={session.site.siteUrl} />;
  ...
  return result.kind === "failure"
    ? <StateNotice reason={result.reason} retryHref="/people" siteUrl={session.site.siteUrl} />
